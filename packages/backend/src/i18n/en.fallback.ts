/**
 * Baked-in English translations — used when /config/locales/ is absent or empty.
 * Must stay in sync with packages/backend/seed/locales/en.yml.
 */
export const EN_FALLBACK: Record<string, unknown> = {
  ...
  widgetConfig: {
    ...
    colors: {
      ...
      bgLockedByTheme: 'Background is set by the current theme',
      token: {
        accent: 'Accent',
        muted: 'Muted',
        surface1: 'Surface 1',
