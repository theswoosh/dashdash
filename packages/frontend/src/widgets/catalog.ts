...
export const WIDGET_CATALOG: WidgetTemplate[] = [
  {
    ...
    label: 'Healthcheck',
    icon: Activity,
    description: 'Monitor a URL for uptime and latency',
    defaultSize: { w: 3, h: 2 },
    defaultOptions: { url: 'https://example.com', timeoutMs: 5000 },
    configFields: [
      { key: 'url', label: 'URL', type: 'url', placeholder: 'https://example.com', required: true },
      { key: 'name', label: 'Display name', type: 'text', placeholder: 'My Service' },
